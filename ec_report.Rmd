...
whole3
```
From what I understand, there does to seem to be any uncertainty associated with the absolute difference (i.e. "subtracting the percentage of patients with one or more events in the placebo group from the corresponding percentage of patients in the digoxin group") [@doi:10.1056/NEJM199702203360801] in table 4.
